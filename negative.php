...
<html>
  ...
  <div class="row" >
    <div class="col-xs-12 col-sm-12" align=center>
      <p style="margin-top:30px"><font face= "微軟正黑體", "Microsoft JhengHei">---點擊新聞標籤看各家新聞---</font></p>
    </div>
  </div>
  ...
  <div  align="center">
		...
		<?php 
  			...
  			$sql="select negative.news_id,negative.name,list_news.date,list_news.category from negative,list_news  where negative.news_id = list_news.id order by date desc"; //查詢資料
